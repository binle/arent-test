...
export class EnumUtil {
  static getNamesAndValues<T extends EnumValueType>(enumType: any): { name: string; value: T }[] {
  ...
  static getNameFromValue<T extends EnumValueType>(enumType: any, value: T): string | null {
